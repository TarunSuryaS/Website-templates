...
function StickyActions() {
  const whatsappUrl = WHATSAPP_NUMBER
    ? `https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20${encodeURIComponent(CLINIC_NAME)},%20I%20would%20like%20to%2520inquire%2520about%2520a%2520dental%2520appointment.`
    : '#'
    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden px-4 pb-4 pt-2 bg-gradient-to-t from-slate-50 via-slate-50/90 to-transparent">
      <div className="glass-card p-2 rounded-2xl flex items-center justify-between gap-3 shadow-2xl border border-white/80">
        ...
        >
          ...
          <span className="text-[15px] tracking-wide font-extrabold">Call Now</span>
        </a>
        ...
        >
          ...
          <span className="text-[15px] tracking-wide font-extrabold">WhatsApp</span>
        </a>
