...
function EmergencyCare() {
  const whatsappUrl = WHATSAPP_NUMBER
    ? `https://wa.me/${WHATSAPP_NUMBER}?text=URGENT:%20I%20have%2520severe%2520tooth%2520pain/swelling%2520and%2520need%2520immediate%2520dental%2520assistance.`
    : '#'
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center text-center space-y-6 md:space-y-8">
            ...
            <div className="inline-flex items-center space-x-2.5 bg-rose-500/20 text-rose-300 px-4 py-1.5 rounded-full text-xs font-extrabold border border-rose-500/20 uppercase tracking-widest animate-pulse">
              ...
              <span>Dental Helpline Active</span>
            </div>

            {/* Main Title */}
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight max-w-3xl">
              Severe Tooth Pain? Get Dental Help Quickly
            </h2>

            {/* Sub-text */}
            <p className="text-slate-300 font-semibold text-base sm:text-lg max-w-2xl leading-relaxed">
              If you have sudden tooth pain, swelling, bleeding gums, broken tooth, or dental injury, contact the clinic for guidance and appointment support.
            </p>
            ...
            <div className="pt-4 flex items-center space-x-2 text-xs font-bold text-slate-400">
              ...
              <span>Timings, contact details, and routing can be customized easily post-clinic confirmation.</span>
            </div>
