...
import { CLINIC_NAME, PHONE_NUMBER, WHATSAPP_NUMBER, MAPS_URL, CLINIC_ADDRESS, CLINIC_TIMINGS, handleActionClick } from '../constants'

function Contact() {
  const whatsappUrl = WHATSAPP_NUMBER
    ? `https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20${encodeURIComponent(CLINIC_NAME)},%20I'd%20like%20to%20get%20directions%20or%2520confirm%252520your%252520clinic%252520location.`
    : '#'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16 space-y-4">
          ...
          <p className="text-slate-500 font-semibold text-base sm:text-lg">
            Connect with us online or drop by for a consultation once our location details are finalized.
          </p>
        </div>
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm font-extrabold text-clinicTeal mt-1">
                  “Trusted Dental Care for Healthy Smiles”
                </p>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-400 font-semibold block mt-0.5">Will be configured after clinic confirmation</span>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    {PHONE_NUMBER ? (
                      <a href={`tel:${PHONE_NUMBER}`} className="font-extrabold text-slate-800 text-lg hover:text-clinicTeal transition-colors block mt-0.5">
                        {PHONE_NUMBER}
                      </a>
                    ) : (
                      <p className="font-extrabold text-slate-700 text-sm mt-0.5 leading-relaxed">
                        Add phone number here after confirmation
                      </p>
                    )}
                    <span className="text-xs text-slate-400 font-semibold block mt-0.5">Will be updated after approval</span>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-slate-400 font-semibold block mt-0.5">Custom clinic timings</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4 border-t border-slate-100/60">
              ...
              <a
                ...
                className="flex items-center justify-center space-x-1.5 py-3.5 px-4 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-extrabold text-xs shadow-md shadow-emerald-500/10 active:scale-95 transition-all text-center"
              >
          ...
          >
            <div className="relative w-full min-h-[300px] bg-slate-100 rounded-3xl border border-slate-200 overflow-hidden flex flex-col justify-between p-6 shadow-md shadow-slate-100 group">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center pointer-events-none">
                ...
                <div className="w-8 h-8 rounded-full bg-rose-500 flex items-center justify-center text-white shadow-xl shadow-rose-500/30 animate-bounce">
              ...
              <div className="glass-card p-4 rounded-2xl border border-white/80 w-full max-w-sm text-left shadow-lg shrink-0">
                <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest block">Google Maps Location</span>
                <p className="text-xs text-slate-600 font-semibold mt-1 leading-relaxed">
                  Google Maps location will be added here upon address confirmation.
                </p>
              </div>
