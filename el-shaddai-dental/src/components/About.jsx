...
function About() {
  const coreValues = [
    ...
    "Sterilized, patient-friendly rooms",
    "Located centrally in Kolathur, Chennai"
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900 leading-tight">
              About El-Shaddai Dental Clinic & Implant Center
            </h2>

            <p className="text-base sm:text-lg text-slate-600 font-medium leading-relaxed">
              El-Shaddai Dental Clinic & Implant Center is a dental care clinic focused on affordable, patient-friendly, and reliable dental treatment. The clinic helps patients with tooth pain, gum problems, dental implants, wisdom tooth issues, cleaning, root canal treatment, and emergency dental needs.
            </p>
            ...
            <div className="glass-card p-5 rounded-2xl border-l-4 border-l-clinicTeal bg-white/90 flex items-start space-x-3.5 shadow-sm mt-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 font-medium leading-relaxed">
                  Doctor name, exact timings, and treatment pricing can be updated after clinic confirmation.
                </p>
              </div>
            </div>
          </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <span className="font-extrabold text-slate-800 text-sm block mt-0.5">24 Hours / 7 Days a Week</span>
                    <span className="text-xs text-slate-500 font-medium mt-0.5 block">Emergency calls answered instantly</span>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <span className="font-extrabold text-slate-800 text-sm block mt-0.5">Kolathur, Chennai</span>
                    <span className="text-xs text-slate-500 font-medium mt-0.5 block">Tamil Nadu, India</span>
                  </div>
                </div>
