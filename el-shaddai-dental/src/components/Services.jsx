...
import { Smile, AlertCircle, Zap, Shield, Sparkles, Droplets, Trash2, Activity } from 'lucide-react'

function Services() {
  const services = [
    {
      title: "Dental Implants",
      desc: "Permanent tooth replacement solutions for missing teeth with natural-looking restorations.",
      icon: <Shield className="w-6 h-6 text-clinicTeal" />,
      color: "from-teal-500/10 to-teal-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I'd like to enquire about Dental Implants treatment."
    },
    {
      title: "Tooth Pain Treatment",
      desc: "Quick and gentle care for sudden tooth pain, sensitivity, swelling, and deep infections.",
      icon: <AlertCircle className="w-6 h-6 text-rose-500" />,
      color: "from-rose-500/10 to-rose-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I need urgent assistance regarding sudden Tooth Pain."
    },
    {
      title: "Root Canal Treatment",
      desc: "Safe and pain-free tooth-saving treatment to resolve deep decay and severe nerve pain.",
      icon: <Zap className="w-6 h-6 text-clinicSky" />,
      color: "from-sky-500/10 to-sky-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I'd like to ask about Root Canal Treatment."
    },
    {
      title: "Wisdom Tooth Removal",
      desc: "Safe, expert surgical treatment for painful, impacted, or crowded wisdom teeth.",
      icon: <Trash2 className="w-6 h-6 text-slate-600" />,
      color: "from-slate-500/10 to-slate-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I'd like to get information on Wisdom Tooth Removal."
    },
    {
      title: "Gum Care",
      desc: "Advanced treatment for bleeding gums, swelling, persistent bad breath, and gum infections.",
      icon: <Sparkles className="w-6 h-6 text-emerald-500" />,
      color: "from-emerald-500/10 to-emerald-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I'd like to consult for Gum Care and treatment."
    },
    {
      title: "Teeth Cleaning",
      desc: "Professional scaling and polishing for clean, sparkling, and healthy teeth and gums.",
      icon: <Droplets className="w-6 h-6 text-indigo-500" />,
      color: "from-indigo-500/10 to-indigo-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I want to book an appointment for Teeth Cleaning & scaling."
    },
    {
      title: "Cosmetic Dentistry",
      desc: "Smile improvement, premium veneers, teeth whitening, and aesthetic dental care treatments.",
      icon: <Smile className="w-6 h-6 text-pink-500" />,
      color: "from-pink-500/10 to-pink-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I'd like to enquire about Cosmetic Dentistry and smile enhancement."
    },
    {
      title: "Emergency Dental Care",
      desc: "Immediate diagnostic support for severe toothache, broken tooth, swelling, or dental injuries.",
      icon: <Activity className="w-6 h-6 text-amber-500" />,
      color: "from-amber-500/10 to-amber-600/5",
      whatsappText: "Hi El-Shaddai Dental Clinic, I have a Dental Emergency and require immediate support."
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16 space-y-4">
          ...
          <p className="text-slate-500 font-medium text-base sm:text-lg">
            We provide a wide range of high-quality treatments at highly affordable prices, ensuring healthy and happy smiles.
          </p>
        </div>
          ...
          {services.map((service, idx) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100/60 flex items-center justify-between gap-2.5">
                ...
                <a
                  href={`https://wa.me/919962468076?text=${encodeURIComponent(service.whatsappText)}`}
                  target="_blank"
        ...
        <div className="mt-10 text-center">
          <p className="text-xs font-semibold text-slate-400">
            * Affordable dental care near you • Easy appointment booking through phone or WhatsApp
          </p>
        </div>
